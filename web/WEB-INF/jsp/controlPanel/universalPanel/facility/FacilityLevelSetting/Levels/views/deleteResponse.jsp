<%-- 
    ...
    Created on : Dec 8, 2017, 10:16:41 AM
    Author     : samuelwam
--%>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" onClick="ajaxSubmitData('categoryLevelSetting.htm', 'workPane', 'act=a&i=0&b=a&c=a&d=0&ofst=1&maxR=100&sStr=', 'GET');">
                    &times;
                </button>
                <h4><i class="fa fa-cut"></i>Discard School Type/Level</h4>
            </div>
                            ...
                            <div class="panel-body">
                                <table class="table table-striped table-bordered table-hover table-full-width" id="delOrg_1">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th class="hidden-xs">Type/Level</th>
                                            <th>Attachments</th> 
                                            <th>Status</th>
                                        </tr>
                                    </thead>
