                ...
                <div class="panel-body">
                    ...
                    <c:forEach varStatus="status" begin="1" end="${model.levels}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text"  placeholder="Level ${count} Name" class="form-control" id="levelname${count}" name="levelname${count}">
                            </div>
                            <div class="col-sm-3">
                ...
                <div class="col-sm-12">
                    <div class="form-actions" align="center">
                        ...
                        <div align="left" style="alignment-adjust: central;">
                            <div id="btnSaveHide">
                                <input type="button" id="saveButton" name="button" class="btn btn-purple" value='<c:if test="${empty model.catObjArr}">Save</c:if><c:if test="${not empty model.catObjArr}">Update</c:if> Category Level' onClick="var resp = validateB4Submit();
                                    if (resp === false) {
                                        return false;
                                    }
                                    ajaxSubmitForm('regCategoryLevels.htm', 'TempDialogDiv', 'submitData');"/> 
                                    &nbsp;&nbsp;
