<%-- 
    Document   : programs
    Created on : Nov 6, 2018, 5:26:35 PM
    Author     : Uwera
--%>
...
<script>
    ...
    function addProgram(program,desc,key,id){
        ...
        var pHtmlContent =  
                    ...
                    '<input type="text" id="key" name="key" value="'+devkey+'" placeholder="Enter Program Key" readonly="readonly" class="form-control col-md-8"/>' +
                    ...
                    action: function () {
                        ...
                        if (validateOptions === false) {
                            ...
                            $('#enteredItemsBody').append(
                                    '<tr id="row' + addedRecs + '">' +
                                    '<td>' + program + '<input type=\'hidden\' name=\'kName' + addedRecs + '\' id=\'kName' + addedRecs + '\' value=\'' + program + '\'/><input type=\'hidden\' name=\'pKey' + addedRecs + '\' id=\'pKey' + addedRecs + '\' value=\'' + devkey + '\'/></td>' +
                                    '<td class="center">' +
