<%-- 
    Document   : services
    Created on : Jul 20, 2018, 8:55:17 AM
                                                ...
                                                <table class="table table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Triage</td>
                                                            <td>
                                                                <input type="checkbox" style="display: unset !important; margin-top: 7px" class="form-control col-md-3" id="triaage" name="triage" value="triage" onChange="addService('Traige', 'triageDesc', 'triageKey', 'triage');"/>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="checkbox" style="display: unset !important; margin-top: 7px" class="form-control col-md-3" id="SupplyStoreUnit" name="supplystoreunit" value="supplyunit" onChange="addService('Supply Store Unit', 'supplyunitstoreDesc', 'supplyunitstoreKey', 'SupplyStoreUnit');"/>
