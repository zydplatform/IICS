<%-- 
    Document   : discardVillage
    Created on : Jun 26, 2018, 5:46:41 PM
    Author     : user
--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 170%;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Manage Village</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onClick="ajaxSubmitData('locations/manageVillage.htm', 'regionContent', 'act=a&i=0&b=a&c=a&d=0&ofst=1&maxR=100&sStr=', 'GET'); clearDiv('response-pane');" >
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container" id="transfer-pane">
                    <fieldset><legend>Discard Village: <span color="red">${model.checkObj[1]}</span></legend>
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <div class="tile-body">
                                        ...
                                        <c:forEach items="${model.customList}" var="list" varStatus="status" begin="0" end="${model.size}">
                                            <tr id="${model.village.villageid}">
                                                <td>
                                                    ${status.count}
                                                    <c:set var="i" value="${status.count}"/>
                                                </td>
                                                <td>${model.village.villageid} </td>
                                                <td align="center">
