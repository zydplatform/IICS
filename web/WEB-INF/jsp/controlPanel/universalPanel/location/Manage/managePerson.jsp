<%-- 
    Document   : managePerson
    Created on : Jul 3, 2018, 5:16:34 PM
    Author     : Uwera
--%>
...
<fieldset style="min-height:100px;">
    <legend>
        ...
        &nbsp;
        User/Clients Under Selected Parish: ${model.location[1]}
    </legend>
    ...
    <div class="form-group row">
        ...
        <div class="tile">
            <form id="submitForm" name="submitForm">
                ...
                <div id="recordsBody">
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="personsInParish">
                            <thead>
                                <tr>
                            ...
                            <tbody class="col-md-12" id="tablePersons">
                                <% int y = 1;%>
                                <% int j = 1;%>
                                <c:forEach items="${model.personList}" var="v" varStatus="status" begin="0" end="${model.size}">
                                    <tr id="${status.count}">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    ...
                                    <input type="hidden" size="5" id="locActivity" name="locActivity" value="personTransfer"/>
                                </td>
                                <td align="right">
                            ...
                            <tr>
                                <td colspan="2" align="right">
                                    <div id="checkObjBtn" style="display:none">
                                        <input type="button" value="Transfer Client/User" class="btn btn-primary" onClick="hideDiv('recordsBody'); document.getElementById('locActivity').value = 'personTransfer';  ajaxSubmitForm('locations/searchTransferLoc.htm', 'formDiv', 'submitForm');"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
