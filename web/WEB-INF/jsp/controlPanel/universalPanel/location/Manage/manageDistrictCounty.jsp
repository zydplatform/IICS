<%-- 
    Document   : manageDistrictCounty
    Created on : Jul 13, 2018, 10:50:17 AM
    Author     : user
--%>
...
<fieldset style="min-height:150px;">
    <legend>
        <div style="float:left" align="left"><a id="back" href="#"  onClick="ajaxSubmitData('locations/manageSelectedLoc.htm', 'Response-pane', {id: '${model.location[0]}', act: 'd', st: 'b', v2: '0'}, 'GET');"> <i class="fa fa-backward"></i></a></div>
        &nbsp;
        Counties Under Selected District: ${model.location[1]}
    </legend>

    <div class="form-group row">

        <div class="col-md-8"><label class="control-label col-md-4">Region Name:</label> ${model.location[2]}</div>
        <div class="col-md-8"><label class="control-label col-md-4">District Name:</label> ${model.location[1]}</div>
    </div>
     <div class="tile">
            <form id="submitForm" name="submitForm">
                ...
                <div id="recordsBody">
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="countyInDistrict">
                            <thead>
                                <tr>
                            ...
                            <tbody class="col-md-12" id="tableFacilityOwner">
                                <% int y = 1;%>
                                <% int j = 1;%>
                                <c:forEach items="${model.countyList}" var="v" varStatus="status" begin="0" end="${model.size}">
                                    <tr id="${status.count}">
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    ...
                                    <input type="hidden" size="5" id="locActivity" name="locActivity" value="countyTransfer"/>
                                </td>
                                <td align="right">
                            ...
                            <tr>
                                <td colspan="2" align="right">
                                    <div id="checkObjBtn" style="display:none">
                                        <input type="button" value="Transfer County" class="btn btn-primary" onClick="hideDiv('recordsBody'); document.getElementById('locActivity').value = 'countyTransfer';  ajaxSubmitForm('locations/searchDistictTransferLoc.htm', 'formDiv', 'submitForm');"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
