<%-- 
    Document   : manageDistrictParish
    Created on : Jul 13, 2018, 10:49:37 AM
    Author     : user
--%>
...
<fieldset style="min-height:150px;">
    <legend>
        ...
        &nbsp;
        Parishes Under Selected District: ${model.location[1]}
    </legend>
    ...
    <div class="tile">
        <form id="submitForm" name="submitForm">
            ...
            <div id="recordsBody">
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="parishInDistrict">
                        <thead>
                            <tr>
                        ...
                        <tr>
                            <td colspan="2" align="right">
                                <div id="checkObjBtn" style="display:none">
                                    <input type="button" value="Transfer Parish" class="btn btn-primary" onClick="hideDiv('recordsBody');
                                                document.getElementById('locActivity').value = 'parishTransfer';  ajaxSubmitForm('locations/searchDistictTransferLoc.htm', 'formDiv', 'submitForm');"/>
                                </div>
                            </td>
                        </tr>
                    </table>
