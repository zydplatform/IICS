<%-- 
    ...
    Created on : Jul 3, 2018, 5:12:07 PM
    Author     : Uwera
--%>
...
<fieldset style="min-height:100px;">
    <legend>
        ...
        &nbsp;
        Facilities Under Selected Parish: ${model.location[1]}
    </legend>
    ...
    <div class="form-group row">
        ...
        <div class="tile">
            <form id="submitForm" name="submitForm">
                ...
                <div id="recordsBody">
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="facilitiesInParish">
                            <thead>
                                <tr>
                            ...
                            <tbody class="col-md-12" id="tableFacility">
                                <% int y = 1;%>
                                <% int j = 1;%>
                                <c:forEach items="${model.facilityList}" var="v" varStatus="status" begin="0" end="${model.size}">
                                    <tr id="${status.count}">
                            ...
                            <tr>
                                <td colspan="2" align="right">
                                    <div id="checkObjBtn" style="display:none">
                                        <input type="button" value="Transfer Facility" class="btn btn-primary" onClick="hideDiv('recordsBody'); document.getElementById('locActivity').value = 'facilityTransfer';  ajaxSubmitForm('locations/searchTransferLoc.htm', 'formDiv', 'submitForm');"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
