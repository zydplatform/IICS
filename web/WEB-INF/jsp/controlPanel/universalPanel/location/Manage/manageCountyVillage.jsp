<%-- 
    Document   : manageCountyVillage
    Created on : Aug 16, 2018, 6:51:24 PM
    Author     : Uwera
--%>
...
<fieldset style="min-height:150px;">
    <legend>
        ...
        &nbsp;
        Villages Under Selected County: ${model.location[1]}
    </legend>
    ...
    <div class="form-group row">
        ...
        <div class="tile">
            <form id="submitForm" name="submitForm">
                ...
                <div id="recordsBody">
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="villagesInCounty">
                            <thead>
                                <tr>
                            ...
                            <tr>
                                <td colspan="2" align="right">
                                    <div id="checkObjBtn" style="display:none">
                                        <input type="button" value="Transfer Village" class="btn btn-primary" onClick="hideDiv('recordsBody'); document.getElementById('locActivity').value = 'villageTransfer';  ajaxSubmitForm('locations/searchCountyTransfer.htm', 'formDiv', 'submitForm');"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
