<%-- 
    Document   : manageSubCountyVillage
    Created on : Jul 5, 2018, 12:15:33 PM
    Author     : user
--%>
...
<fieldset style="min-height:150px;">
    <legend>
        ...
        &nbsp;
        Villages Under Selected Sub County: ${model.location[1]}
    </legend>
    ...
    <div class="form-group row">
        ...
        <div class="tile">
            <form id="submitForm" name="submitForm">
                ...
                <div id="recordsBody">
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="villagesInSubcounty">
                            <thead>
                                <tr>
                        ...
                        <table align="right">
                            <tr>
                                <td>
                                    ...
                                    <input type="hidden" size="5" id="locActivity" name="locActivity" value="villageTransfer"/>
                                </td>
                                <td align="right">
                            ...
                            <tr>
                                <td colspan="2" align="right">
                                    <div id="checkObjBtn" style="display:none">
                                        <input type="button" value="Transfer Village" class="btn btn-primary" onClick="hideDiv('recordsBody'); document.getElementById('locActivity').value = 'villageTransfer';  ajaxSubmitForm('locations/searchSubcountyTransfer.htm', 'formDiv', 'submitForm');"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
