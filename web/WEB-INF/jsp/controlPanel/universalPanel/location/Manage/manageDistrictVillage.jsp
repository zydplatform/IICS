<%-- 
    Document   : manageDistrictVillage
    Created on : Jul 13, 2018, 10:49:20 AM
    Author     : user
--%>
...
<fieldset style="min-height:150px;">
    <legend>
        ...
        &nbsp;
        Villages Under Selected District: ${model.location[1]}
    </legend>

    <div class="form-group row">
        <div class="col-md-8"><label class="control-label col-md-4">Village Name:</label> ${model.location[1]}</div>
        <div class="col-md-8"><label class="control-label col-md-4">Parish Name:</label> ${model.location[2]}</div>
        <div class="col-md-8"><label class="control-label col-md-4">Sub-County Name:</label> ${model.location[3]}</div>
        <div class="col-md-8"><label class="control-label col-md-4">County Name:</label> ${model.location[4]}</div>
    </div>
        ...
        <div class="tile">
            <form id="submitForm" name="submitForm">
                ...
                <div id="recordsBody">
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="villagesInDistrict">
                            <thead>
                                <tr>
