<%-- 
    ...
    Created on : Aug 13, 2018,10:42:45 AM
    Author     : Uwera
--%>
        ...
        <div class="col-md-6">
            <div class="tile">
                ...
                <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">Previous Village</label>
                            <input class="form-control" id="prevVillage" name="prevVillage" type="text" placeholder="Previous Village" readonly="readonly" value="${model.audObj[10]}">
        ...
        <div class="col-md-6">
            <div class="tile">
                <h4 class="tile-title">Current Information</h4>
                    ...
                    <div class="form-group">
                        <label class="control-label">Current Village</label>
                        <input class="form-control" id="curVillage" name="curVillage" type="text" placeholder="Current Village" readonly="readonly" value="${model.audObj[16]}">
                        <input type="hidden" name="curLocation" value="${model.audObj[22]}"/>
                    </div>
            </div>
        </div>
        <div class="col-md-12 aligncenter">
            <button class="btn btn-primary aligncenter" id="revertAction" type="button" onClick="ajaxSubmitData('locations/locationsAuditor.htm', 'content', 'act=f&i=${model.audObj[0]}&b=a&c=a&d=${model.audObj[22]}&ofst=1&maxR=100&sStr=${model.dbaction}', 'GET');">
                <i class="fa fa-fw fa-lg fa-plus-circle"></i>
                Revert ${model.dbaction}
            </button>
            
            <button class="btn btn-primary aligncenter" id="confirmAction" type="button" onClick="ajaxSubmitData('locations/locationsAuditor.htm', 'content', 'act=g&i=${model.audObj[0]}&b=a&c=a&d=0&ofst=1&maxR=100&sStr=${model.dbaction}', 'GET');">
                <i class="fa fa-fw fa-lg fa-plus-circle"></i>
...
<c:if test="${model.dbaction=='Delete'}">
    <div class="row" id="content2">
        ...
        <c:if test="${empty model.parishObj}">
            <div class="col-md-6">
                <div class="tile">
                    <h4 class="tile-title"><span style="color:red; font-weight:bolder">Missing Destination!</span></h4>
                    <div class="form-group">
                        Previous Parish Object Not Found! Reset Destination
                    </div>
                </div>
            </div>
        </c:if>
        <div class="col-md-12 left">
            <button class="btn btn-primary aligncenter" id="revertAction" type="button" onClick="ajaxSubmitData('locations/locationsAuditor.htm', 'content', 'act=f&i=${model.audObj[0]}&b=a&c=a&d=${model.audObj[16]}&ofst=1&maxR=100&sStr=${model.dbaction}', 'GET');">
                <i class="fa fa-fw fa-lg fa-plus-circle"></i>
