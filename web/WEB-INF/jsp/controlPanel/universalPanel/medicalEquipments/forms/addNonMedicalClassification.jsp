<%-- 
    Document   : addNonMedicalClassification
    Created on : Oct 30, 2018, 11:49:19 AM
    Author     : IICS
--%>
<style>
    .error
                ...
                <div class="tile-body">
                    <form id="classificationentryform">
                        <div class="form-group">
                            ...
                            <input class="form-control myform"  oninput="checkNonClassName();" id="classificationname" type="text" placeholder="Enter Classification Name">
                       <h6 id='nonclassificationresults'></h6>
                        </div>
                        <div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                <div class="col-sm-12 text-right">
                    <button type="button" class="btn btn-primary" id="saveNClassifications" disabled="true">
    ...
    $('#captureClassDetails').click(function () {
        ...
        if (className !== '') {
            if (classnamestestSet.has(className)) {
                ...
                document.getElementById('saveNClassifications').disabled = false;
...
//CHECKING WHETHER CLASSIFICATION NAME EXISTS
    function checkNonClassName() {
        var classificationname = $('#classificationname').val();
        var classificationresults = $("#nonclassificationresults");
        var size = classificationname.length;
        if (size >= 3) {
            $.ajax({
                type: "POST",
                cache: false,
                url: "medicalandnonmedicalequipment/checkNonMedicalClassificationName.htm",
    ...
    $('#saveNClassifications').click(function () {
        if (classificationObjectList.length > 0) {
            ...
            $.ajax({
                type: 'POST',
                data: data,
                url: 'medicalandnonmedicalequipment/saveNonMedicalClassification.htm',
