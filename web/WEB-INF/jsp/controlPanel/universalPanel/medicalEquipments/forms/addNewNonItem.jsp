<%-- 
    Document   : addNewNonItem
    Created on : Oct 30, 2018, 12:38:36 PM
    Author     : IICS
--%>
        ...
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form id="itementryform">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control myform"  oninput="checkNonMedicalEquipmentName();" id="equipmentname" type="text" placeholder="Enter Item Name">
                            <h6 id="nonItemResults"></h6>
                        </div>
                        <div class="form-group">
                ...
                <div class="tile-footer">
                    <button class="btn btn-primary" id="captureNonMedicalItemsDetails" type="button">
...
<script>
    ...
    $('#captureNonMedicalItemsDetails').click(function () {
    ...
    function checkNonMedicalEquipmentName(){
        var assetclassificationid = $('#assetclassificationid').val();
        var equipmentname = $('#equipmentname').val();
        var nonItemResults = $("#nonItemResults");
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data === "exists") {
                        ...
                        nonItemResults.css("color", "red");
                        nonItemResults.text(equipmentname + " Already Exists");
                    } else {
                        $('#equipmentname').removeClass('error');
                        nonItemResults.css("color", "green");
                        nonItemResults.text(" ");
                    }
                }
            });
    ...
    $('#saveEquipments').click(function () {
        ...
        if (itemObjectList.length > 0) {
            ...
            $.ajax({
                type: 'POST',
                data: data,
                url: 'medicalandnonmedicalequipment/saveNonMedicalEquipment.htm',
