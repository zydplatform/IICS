<%-- 
    Document   : viewRequestedItemsIssued
    Created on : Nov 13, 2018, 4:38:57 AM
    Author     : HP
--%>
...
<div class="tile">
    <div class="tile-body">
        <table class="table table-hover table-bordered col-md-12" id="table-view-orders-items3">
...
<script>
    $('#table-view-orders-items3').DataTable();
</script>