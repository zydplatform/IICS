                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Temporary Login!</h4>
                            </div>
                                        ...
                                        <fieldset>
                                            <div class="form-group">
                                                <span class="input-icon">
                                                    <input type="text" class="form-control" name='j_username' id="username" placeholder="Username" style="width:250px">
                                                    <i class="fa fa-user"></i> </span>
                                            </div>
                                            <div class="form-group form-actions">
                                                <span class="input-icon">
                                                    <input type="password" class="form-control password" name="j_password" id="passwrd" placeholder="Password" style="width:250px">
                                                    <i class="fa fa-lock"></i>
                                                    <a class="forgot" href="#" onClick="return false;">
                                                        I forgot my password
                                                    </a> </span>
                                            </div>
                                            <div class="form-actions">
                                                <button type="submit" class="btn btn-bricky pull-right" onClick="
                                                    if ($('#form2 input[id=username]').val() === '' || $('#form2 input[id=passwrd]').val() === '') {
                                                        if ($('#form2 input[id=username]').val() === '')
                                                            $('#mc_msg').html('Missing Username!!');
                                                        else if ($('#form2 input[id=passwrd]').val() === '')
                                                            $('#mc_msg').html('Missing Password!!');
                                                    }
                                                    else {
                                            ...
                                            <div class="new-account">
                                                ...
                                                <a href="#" onClick="return false;" class="register">
                    ...
                    <div class="fullwidthabnner">
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                                ...
                                <a class="caption lft btn btn-bricky slide_btn slide_item_left" href="#" onClick="alert('Under Implememtation!');"
                                   data-x="0"
                                   data-y="320"
                                   data-speed="400"
                                   data-start="3000"
                            ...
                            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                                ...
                                <div class="caption lfr slide_desc slide_item_left"
                                     ...
                                     data-start="2500"
                                     data-easing="easeOutExpo">
                                    Protecting you from identity theft and faud.
                                    <br>
                                    Authenticator will require you to answer some questions.							</div>
                                <a class="caption lfb btn btn-bricky slide_btn slide_item_left" href="#panel-config" data-toggle="modal" onClick="$('#username').val(''); $('#passwrd').val('');//window.open('mainPage.htm');"
                                   data-x="0"
                                   data-y="320"
                                   data-speed="400"
                                   data-start="3000"
