...
(function ($, window, document, undefined) {
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            ...
            this.container = $('' +
                    '<div class="bootstrap-duallistbox-container" style="">' +
                    ' <div class="box1">' +
                    '<h6 style = "color:green"><b>List of Offecnce(s)</b></h6>' +
                    '   <label></label>' +
                    '   <span class="info-container">' +
                    '     <span class="info"></span>' +
                    '     <button type="button" class="btn clear1 pull-right"></button>' +
                    '   </span>' +
                    '   <div class="btn-group buttons" style="float:left">' +
                    '     <button type="button" class="btn move">' +
                    '       <i></i>' +
                    '     </button>' +
                    '   </div>' +
                    '   <input class="filter" type="text" style="width:300px;float:left;padding-right:3px">' +
                    '   <select multiple="multiple"></select>' +
                    ' </div>' +
                    ' <div class="box2">' +
                    '<h6 style = "color:green"><b>Selected List (This represents Offence(s) committed by the Student)</b></h6>' +
                    '   <label></label>' +
                    '   <span class="info-container">' +
                    '     <span class="info"></span>' +
                    ...
                    '     </button>' +
                    '   </div>' +
                    '   <input class="filter" type="text"  style="width:250px;float:left;padding-right:3px">' +
                    '   <select multiple="multiple"></select>' +
                    ' </div>' +
                    '</div>')
