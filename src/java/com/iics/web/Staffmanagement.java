...
public class Staffmanagement {
    ...
    public String staffmanagmentmenu(Model model) {
        return "staffManagment/staffmanagementmenu";
    }
...
//    
    ...
    public String registeruser(Model model, HttpServletRequest request) {
        ...
        return "staffManagment/registerStaff/manageUsers";
    }
    ...
    String searchstaffs1(HttpServletRequest request, Model model,
        ...
        return "staffManagment/registerStaff/usersearchresult";
    ...
    public String registernewstaff(HttpServletRequest request, Model model,
        ...
        if (found61 != null) {
            for (Object[] req1 : found61) {
                ...
                if (!existing.contains(req1[0].toString().toLowerCase())) {
                    designationnames.put("designationname", capitalize_first_leter(req1[0].toString()));
                    designationnames.put("designationid", (Integer) req1[1]);
                    designations.add(designationnames);
                    existing.add(req1[0].toString().toLowerCase());
                }
            }
        }
        //Fetch units
        ...
        return "staffManagment/registerStaff/views/Staffregform";
    }
    ...
    public String userdetails(Model model, HttpServletRequest request
        ...
        if (found != null) {
            ...
            String[] fields111 = {"firstname", "lastname", "facilityid.facilityid", "othernames", "gender", "title"};
            ...
            if (found1 != null) {
                ...
                model.addAttribute("gender", (String) f[4]);
                if (f[5] != null) {
                    model.addAttribute("title", (String) f[5]);
                } else {
                ...
                if (f[4] != null) {
                    ...
                    model.addAttribute("gender", "Pending");
                }
            }
            //Fetch designation
        ...
        model.addAttribute("designations", designations);
        model.addAttribute("units", units);
        return "staffManagment/registerStaff/views/Userdetails";
    }
    ...
    public final ModelAndView savenewuser(HttpServletRequest request) throws SQLException {
        ...
        return new ModelAndView("staffManagment/registerStaff/manageUsers", "model", model);
    }
    ...
    public final ModelAndView addmail(HttpServletRequest request
        ...
        return new ModelAndView("staffManagment/registerStaff/views/Userdetails", "model", model);
    }
    ...
    public String staffunits(HttpServletRequest request, Model model
        ...
        return "staffManagment/registerStaff/views/staffunits";
    }
    ...
    public String facilityunits(HttpServletRequest request, Model model) {
        ...
        model.addAttribute("staffid", staffid);
        model.addAttribute("staffunits", staffunits);
        return "staffManagment/registerStaff/views/facilityunits";
    }
...
//   }
    ...
    public @ResponseBody
    String updateTitle(Model model, HttpServletRequest request) {
//        Long updatepersonid = Long.parseLong(request.getParameter("personid"));
        String updateTitle = request.getParameter("updateTitle");
        Long pid = Long.parseLong(request.getParameter("personid"));

        String[] columns = {"title"};
        Object[] columnValues = {updateTitle};
        String pk = "personid";
        Object pkValue = pid;
        genericClassService.updateRecordSQLSchemaStyle(Person.class, columns, columnValues, pk, pkValue, "public");
        return updateTitle;
    ...
    public String checkemail(HttpServletRequest request, Model model) {
        ...
        String wheres = "WHERE contactvalue=:contactvalue";
        List<Object[]> objpatientgender = (List<Object[]>) genericClassService.fetchRecord(Contactdetails.class, fields, wheres, columns, columnValues);
