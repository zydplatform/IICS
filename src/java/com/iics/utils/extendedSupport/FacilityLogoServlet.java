 ...
 * @author samuelwam
 */
public class FacilityLogoServlet extends HttpServlet {
    // Constants ----------------------------------------------------------------------------------

    private static final int DEFAULT_BUFFER_SIZE = 10240; // 10KB.
    static final Logger logger = Logger.getLogger(FacilityLogoServlet.class.getName());
    // Properties ---------------------------------------------------------------------------------
    ...
    public void init() throws ServletException {
        ...
        if (OsCheck.getOperatingSystemType().toString().equals("Windows")) {
            (new File("C:\\IICS\\Pharmaceuticals\\Logos\\")).mkdirs();
            this.imagePath = "C:\\IICS\\Pharmaceuticals\\Logos\\";
            logger.info("Detected that your Server is: Windows");
        } else if (OsCheck.getOperatingSystemType().toString().equals("Linux")) {
            (new File("/home/IICS/Pharmaceuticals/Logos/")).mkdirs();
            this.imagePath = "/home/IICS/Pharmaceuticals/Logos/";
            logger.info("Detected that your Server is: Linux/Unix");
        } else if (OsCheck.getOperatingSystemType().toString().equals("MacOS")) {
            (new File("/Users/IICS/Pharmaceuticals/Logos")).mkdirs();
            this.imagePath = "/Users/IICS/Pharmaceuticals/Logos/";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        File file = new File(imagePath, URLDecoder.decode(requestedFile, "UTF-8"));
